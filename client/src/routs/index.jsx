...
export default function Index() {
  return (
    <section className=" p-4 gap-4 grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-12 dark:bg-gray-700">
      <div className="  min-h-screen hidden lg:block  col-span-3 ">
      ...
      <div className="font-bold col-span-4 lg:col-span-6">
